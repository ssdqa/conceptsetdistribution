## code to prepare `csd_concept_set` dataset goes here

csd_concept_set <- tibble::tibble(concept_id = c(45542739, 1567956, 40164882, 40063353, 3007263, 40758583),
...
usethis::use_data(csd_concept_set, overwrite = TRUE)
