...
If using the OMOP CDM, `concept_id` should be input as the concept
column. For the PCORnet CDM, `concept_code` should be input as the
concept column. The `p_value` can be selected by the user.
